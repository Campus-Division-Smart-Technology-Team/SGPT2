...
def render_tabs():
    ...
    with tab2:
        st.write(
            ...
            Alfred can recognize building names and their common abbreviations. The system uses a dynamic cache loaded from the property database, which includes:
            ...
            - Prioritize results from the correct building
        ...
        with col1:
            st.markdown(
                ...
                **Building abbreviations:**
                - "How many floors does BDFI have?" (65 Avon Street)
                - "Tell me about SHB" (Senate House Building)
                """
            )
        with col2:
            st.markdown(
                ...
                **Cross-building queries:**
                - "Compare the BMS systems in Senate House and Berkeley Square"
...
def render_sidebar():
    ...
    with st.sidebar:
        ...
        # Show building cache status
        from building_utils import _CACHE_POPULATED, get_building_names_from_cache, get_cache_status
